...
parser.add_argument("--dataset_dir", type=str, default="./dataset/multiqa/hotpotqa.jsonl")
parser.add_argument("--model-name", type=str, default="state-spaces/mamba-130m")
parser.add_argument("--prompt", type=str, default=None)
parser.add_argument("--promptlen", type=int, default=50)
parser.add_argument("--genlen", type=int, default=50)
...
for i, line in enumerate(tqdm(lines)):
    ...
    if prompt is None:
        ...
        input_ids1 = tokens1.input_ids.to(device=device)
        attn_mask1 = tokens1.attention_mask.to(device=device)
        # len(input_ids1) == 51, len(input_ids2) == 136
        input_ids2 = tokens2.input_ids.to(device=device)
        attn_mask2 = tokens2.attention_mask.to(device=device)
...
with open(args.out_dir+"/{}/{}.jsonl".format(args.model_name,dataset), "w") as f:
    for line in lines:
        json.dump(line, f)
        f.write("\n")
